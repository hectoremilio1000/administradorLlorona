...
import { StockEventInventario, StockInventariosBotellas } from "../../../models";

function ComprasBotellas({ id }) {
  console.log(id);
  ...
  const onFinish = async values => {
    ...
    try {
      await DataStore.save(
        new StockInventariosBotellas({
          quantity: compras,
          fecha: date,
          inventariobotellasID: id,
        })
      );
...
export default ComprasBotellas;
